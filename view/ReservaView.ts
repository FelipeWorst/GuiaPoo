        ...
        while (true) {
            ...
            switch (escolha) {
                ...
                case "2":
                    ...
                    console.log(" Buscando reserva com ID:", idBusca)
                    const reservaEncontrada = await this.reservaService.buscarPorId(idBusca)
                    console.log(" Resultado:", reservaEncontrada)
                ...
                case "3":
                    ...
                    const emailGuia = this.prompt("Digite o email do guia da Reserva: ")
                    const emailUsuario = this.prompt("Digite o email do usuário da Reserva: ")
                    ...
                    const novaReserva = { idReserva, emailGuia, emailUsuario, dataReserva, dataVolta, valor, pago }
                    console.log(" Criando reserva com os dados:", novaReserva)
                ...
                case "4":
                    ...
                    console.log(" Excluindo reserva com ID:", idDeletar)
                ...
                case "5":
                    ...
                    const novoEmailGuia = this.prompt("Novo email do guia (deixe em branco para manter o atual): ")
                    ...
                    if (novoEmailGuia) dadosAtualizados.emailGuia = novoEmailGuia
