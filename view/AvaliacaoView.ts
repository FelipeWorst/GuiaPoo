        ...
        while (true) {
            ...
            switch (escolha) {
                ...
                case "3":
                    ...
                    const id_passeio_avaliado = this.prompt("Digite o id do passeio a ser avaliado: ")
                    const id_avaliacao = this.prompt("Digite o id da avaliacao: ")
                    ...
                    await this.AvaliacaoService.criar({id_passeio_avaliado, id_avaliacao, nota, comentario, data_avaliacao })
                    break
                case "4":
                    console.table(await this.AvaliacaoService.listar())
