...
export class MainView {
    ...
    constructor() {
        ...
        this.RoteiroView = new RoteiroView()
    ...
    async exibirMenu(): Promise<void> {
        ...
        while (rodando) {
            ...
            console.log("[3] Gerenciar Roteiros")
            console.log("[4] Gerenciar Reservas")
            console.log("[5] Gerenciar Avaliações")
            console.log("[0] Sair")
            ...
            switch (opcao) {
                ...
                case "3":
                    await this.RoteiroView.exibirMenu()
                    break
